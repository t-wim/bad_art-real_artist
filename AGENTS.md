Hier ist die **final konsolidierte `AGENTS.md`** – inkl. der ergänzten **Docs-Abschnitte** (*Deploy, ENV, Troubleshooting*) und allem, was wir iterativ erarbeitet haben. Du kannst die Datei 1:1 ins **Repo-Root** legen.
...
- *(optional)* `GET /api/proxy/health` – `200 { ok: true }`
